...
export default function TopBanner() {
  return (
    <div className="w-full bg-[#001f5c] text-white py-2 px-4 text-xs font-medium border-b border-white/10 hidden sm:block">
      <div className="container mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-white/90">
